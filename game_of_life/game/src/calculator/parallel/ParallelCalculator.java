...
public class ParallelCalculator implements ICalculationExecutor {
    public ParallelCalculator(ExecutorService service, ICalculationExecutor sequentialCalculator) {
        _service = service;
    ...
    public void NextState(ICellsField currentState, ICellsField newState) throws InterruptedException {
        final List<Pair> pairs = _splitter.split(currentState, newState);
